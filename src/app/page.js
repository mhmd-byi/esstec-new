  ...
  return (
    <main className="flex min-h-screen flex-col px-10 lg:px-40 pt-5 lg:pt-16 bg-bg-primary">
      ...
      <div className="hidden">
        ...
        <div className="mt-44 lg:-mt-10 relative">
          <div>
            <p className="block md:hidden text-text-primary text-sm mt-20 mb-60 text-center">For best experience please
              visit the website on your laptop, we are soon coming with our mobile design</p>
            <Image src={esstecLogo} width="w-full" height="h-full" alt="logo"/>
          </div>
          <div className="hidden lg:block absolute bottom-0 top-[-55px] left-0 right-0">
            <DrawingComponent
              draw={draw}
              activeMenu={activeMenu}
              animationComplete={animationComplete}
