...
export const TeamComponent = () => {
  ...
  return (
    ...
    >
      ...
      <p className={`${(checkForScreenSize.screenSize === 1536 || checkForScreenSize.screenSize === 1280) ? 'text-xs' : 'text-sm'} text-text-primary capitalize md:uppercase duration-1000 ease-in-out text-center ${checkForScreenSize.maxWidth} mt-2 md:mt-10`}>
      ...
      <p className={`hidden md:block ${(checkForScreenSize.screenSize === 1536 || checkForScreenSize.screenSize === 1280) ? 'text-xs' : 'text-sm'} text-text-primary capitalize md:uppercase duration-1000 ease-in-out text-center ${checkForScreenSize.maxWidth} mt-2 md:mt-10`}>
      ...
      <p className={`${(checkForScreenSize.screenSize === 1536 || checkForScreenSize.screenSize === 1280) ? 'text-xs' : 'text-sm'} text-text-primary capitalize md:uppercase duration-1000 ease-in-out text-center ${checkForScreenSize.maxWidth} mt-2 md:mt-10`}>
        ...
        <p className={`text-text-primary uppercase ${(checkForScreenSize.screenSize === 1536 || checkForScreenSize.screenSize === 1280) ? 'text-xs' : 'text-sm'} text-center mt-6`}>*</p>
      </p>
    </div>
  );
};
