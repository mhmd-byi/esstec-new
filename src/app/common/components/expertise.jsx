export const ExpertiseComponent = () => {
  return (
    <div className="absolute px-10 md:px-0 right-0 left-0 md:right-auto md:left-auto top-1/2 md:top-56 mt-14 md:mt-10 md:w-[1100px] items-center justify-center z-[60] content-between">
      <div>
