  ...
  return (
    ...
    >
      ...
      <div className={`mt-10 md:mt-52 text-center ${checkForScreenSize.maxWidth}`}>
        <h3 className={`${(checkForScreenSize.screenSize === 1536 || checkForScreenSize.screenSize === 1280) ? 'text-xs' : 'text-sm'} text-text-primary uppercase duration-1000 ease-in-out text-center ${checkForScreenSize.maxWidth} mt-10`}>
          Pick up the phone
        </h3>
        <p className={`${(checkForScreenSize.screenSize === 1536 || checkForScreenSize.screenSize === 1280) ? 'text-xs' : 'text-sm'} text-text-primary uppercase duration-1000 ease-in-out text-center ${checkForScreenSize.maxWidth} mt-10 cursor-pointer`}>
          <a href="tel:+971585428055">+971 5 85 42 8055</a>
        </p>
        <p className={`text-text-primary uppercase ${(checkForScreenSize.screenSize === 1536 || checkForScreenSize.screenSize === 1280) ? 'text-xs' : 'text-sm'} mt-6`}>*</p>
      </div>
    </div>
  );
};
