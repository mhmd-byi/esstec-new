  ...
  return (
    <header className="relative py-2 text-xs leading-6 my-4">
      ...
      <div className="my-4 md:absolute md:left-1/2 md:top-0 md:mt-0 md:flex md:h-full md:-translate-x-1/2 md:items-center">
        {(draw && widthOfScreen < 450) ? <div className="mt-5">.</div> : (<p className="text-center font-semibold uppercase text-text-primary">
      ...
      {(draw && widthOfScreen < 450) ? <div className="mt-5">.</div> : (<div className="flex items-center justify-between">
