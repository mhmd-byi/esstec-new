...
export const ClientComponent = () => {
  ...
  return (
    ...
    >
      ...
      <div
        className={`flex flex-row flex-wrap mt-10 ${checkForScreenSize.maxWidth}`}
      >
        {clientData.map((data, index) => (
          <div
            className={`basis-1/4 justify-between ${
              checkForScreenSize.screenSize <= 1366 ? "py-3" : "py-5"
            }`}
            key={index}
          >
            <div
            ...
            <div
              className={`text-text-primary font-medium lowercase ${
                checkForScreenSize.screenSize === 1536 ||
                checkForScreenSize.screenSize === 1280 ||
                checkForScreenSize.screenSize === 1360 ||
                checkForScreenSize.screenSize === 1366 ||
